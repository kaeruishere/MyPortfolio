        ...
        <div class="p-5 sm:p-7 space-y-3 sm:space-y-4 flex flex-col flex-grow">
            ...
            <div class="mt-auto pt-3 flex gap-2">
                ...
                <a href="${project.githubUrl}" target="_blank" rel="noopener noreferrer"
                    class="flex-grow py-2 rounded-xl bg-[rgb(var(--m3-surface-container-high))] text-[9px] sm:text-[10px] font-bold uppercase tracking-widest text-center hover:bg-[rgb(var(--m3-primary))] hover:text-white transition-all flex items-center justify-center gap-2 border border-white/5">
                ...
                <button class="details-btn px-3 py-2 rounded-xl bg-[rgb(var(--m3-surface-container-high))] hover:bg-[rgb(var(--m3-primary))]/10 transition-all border border-white/5" title="Details">
                    <span class="material-symbols-outlined text-base opacity-60">info</span>
                </button>
            </div>
        </div>
    </div>`;
